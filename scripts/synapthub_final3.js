...
const BMC_BUTTON = '<div style="text-align:center;padding:12px 0;border-top:1px solid #333;"><a href="https://buymeacoffee.com/synaptnetwork" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;background:#FFDD00;color:#000;font-family:Arial,sans-serif;font-weight:700;font-size:13px;padding:9px 18px;border-radius:8px;text-decoration:none;">☕ Apoya SYNAPT Network</a></div>';
